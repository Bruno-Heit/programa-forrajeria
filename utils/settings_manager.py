...
class SettingsManager(QObject):
    ...
    def __new__(cls, *args, **kwargs):
        if not cls._instance:
            ...
            cls._instance.settings = QSettings(PV.APP_NAME.value, PV.APP_AUTHOR.value)
        return cls._instance

    def __init__(
        self,
        app_name: str = PV.APP_NAME.value,
        organization_name: str = PV.APP_AUTHOR.value,
    ) -> None:
        """
    ...
    def saveMainWindowState(
        self, geometry_bytes: QByteArray, state_bytes: QByteArray
    ) -> None:
        """
