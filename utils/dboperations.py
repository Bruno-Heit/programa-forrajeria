...
DATABASE_DIR = (
    user_data_dir(
        appname=PV.APP_NAME.value, appauthor=PV.APP_AUTHOR.value, ensure_exists=True
    )
    + "/database/db_gestion.db"
)
...
class DatabaseRepository:
    ...
    def __executeQuery(
        self, sql: str, params: tuple = None, executemany: bool = False
    ) -> Cursor:
        """
    ...
    def selectRegisters(
        self, data_sql: str, data_params: tuple = None
    ) -> list[tuple[Any]]:
        """
    ...
    def updateRegisters(
        self, upd_sql: str, upd_params: tuple, executemany: bool = False
    ) -> None:
        """
