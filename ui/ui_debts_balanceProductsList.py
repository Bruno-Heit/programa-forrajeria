...
class Ui_ProductsBalance(object):
    def setupUi(self, ProductsBalance):
        ...
        ProductsBalance.resize(400, 260)
        ...
        ProductsBalance.setMinimumSize(QSize(400, 260))
        ProductsBalance.setMaximumSize(QSize(600, 16777215))
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.tv_balance_products.sizePolicy().hasHeightForWidth())
        self.tv_balance_products.setSizePolicy(sizePolicy4)
        self.tv_balance_products.setMinimumSize(QSize(0, 100))
        ...
        sizePolicy2.setHeightForWidth(self.lower_body.sizePolicy().hasHeightForWidth())
        self.lower_body.setSizePolicy(sizePolicy2)
        ...
        sizePolicy5.setHeightForWidth(self.checkbox_show_all_products.sizePolicy().hasHeightForWidth())
        self.checkbox_show_all_products.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.btn_delete_debt.sizePolicy().hasHeightForWidth())
        self.btn_delete_debt.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.le_reduce_debt.sizePolicy().hasHeightForWidth())
        self.le_reduce_debt.setSizePolicy(sizePolicy7)
        ...
        QWidget.setTabOrder(self.search_bar, self.tv_balance_products)
        QWidget.setTabOrder(self.tv_balance_products, self.checkbox_show_all_products)
        QWidget.setTabOrder(self.checkbox_show_all_products, self.btn_delete_debt)
        QWidget.setTabOrder(self.btn_delete_debt, self.le_reduce_debt)
