...
class Ui_listProduct(object):
    def setupUi(self, listProduct):
        ...
        listProduct.resize(768, 101)
        listProduct.setMinimumSize(QSize(580, 91))
...
"}")
        ...
        self.gridLayout.setContentsMargins(9, 5, 5, 5)
        ...
        sizePolicy.setHeightForWidth(self.comboBox_productName.sizePolicy().hasHeightForWidth())
        self.comboBox_productName.setSizePolicy(sizePolicy)
        self.comboBox_productName.setMinimumSize(QSize(70, 25))
        self.comboBox_productName.setMaximumSize(QSize(350, 25))
#if QT_CONFIG(tooltip)
        self.comboBox_productName.setToolTip(u"<html><head/><body><p>El nombre del producto vendido.</p></body></html>")
...
#if QT_CONFIG(tooltip)
        self.lineEdit_productQuantity.setToolTip(u"<html><head/><body><p>La cantidad vendida del producto.</p></body></html>")
#endif // QT_CONFIG(tooltip)
        ...
        sizePolicy.setHeightForWidth(self.label_productMeasurementUnit.sizePolicy().hasHeightForWidth())
        self.label_productMeasurementUnit.setSizePolicy(sizePolicy)
...
#if QT_CONFIG(tooltip)
        self.checkBox_comercialPrice.setToolTip(u"<html><head/><body><p>Aplica el costo comercial al producto.</p></body></html>")
#endif // QT_CONFIG(tooltip)
...
"border-right: 1px solid #111;")
        ...
        sizePolicy1.setHeightForWidth(self.btn_deleteCurrentProduct.sizePolicy().hasHeightForWidth())
        self.btn_deleteCurrentProduct.setSizePolicy(sizePolicy1)
        self.btn_deleteCurrentProduct.setMinimumSize(QSize(30, 30))
        self.btn_deleteCurrentProduct.setMaximumSize(QSize(35, 35))
#if QT_CONFIG(tooltip)
        ...
        icon = QIcon()
        icon.addFile(u"icons/xWhite.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_deleteCurrentProduct.setIcon(icon)
        ...
        sizePolicy.setHeightForWidth(self.lineEdit_saleDetail.sizePolicy().hasHeightForWidth())
        self.lineEdit_saleDetail.setSizePolicy(sizePolicy)
        self.lineEdit_saleDetail.setMinimumSize(QSize(300, 25))
#if QT_CONFIG(tooltip)
        self.lineEdit_saleDetail.setToolTip(u"<html><head/><body><p>Descripci\u00f3n adicional de la venta (opcional).</p><p>Si este campo se deja vac\u00edo se llenar\u00e1 con el producto vendido, la cantidad vendida, la unidad de medida usada para el producto y el tipo de precio que se pag\u00f3 (comercial o normal).</p></body></html>")
#endif // QT_CONFIG(tooltip)
        ...
        sizePolicy2.setHeightForWidth(self.label_quantityFeedback.sizePolicy().hasHeightForWidth())
        self.label_quantityFeedback.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.label_quantityFeedback, 1, 2, 1, 2)

        self.label_nameFeedback = QLabel(listProduct)
        self.label_nameFeedback.setObjectName(u"label_nameFeedback")
        sizePolicy2.setHeightForWidth(self.label_nameFeedback.sizePolicy().hasHeightForWidth())
        self.label_nameFeedback.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.label_nameFeedback, 1, 0, 1, 2)
