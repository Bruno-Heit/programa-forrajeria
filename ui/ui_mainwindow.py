...
"border-right: 1px solid #111;")
        ...
        self.dateTimeEdit_sale.setDisplayFormat(u"d/M/yyyy HH:mm:ss")
...
"}")
        ...
        self.dateEdit_from_date.setDisplayFormat(u"d/M/yyyy")
...
"}")
...
#if QT_CONFIG(tooltip)
        self.btn_add_debtor.setToolTip(u"<html><head/><body><p><span style=\" font-size:12pt;\">Agrega una cuenta corriente nueva a la tabla (</span><span style=\" font-size:12pt; font-style:italic;\">+</span><span style=\" font-size:12pt;\">).</span></p></body></html>")
#endif // QT_CONFIG(tooltip)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(tooltip)
        self.dateEdit_to_date.setDisplayFormat(QCoreApplication.translate("MainWindow", u"d/M/yyyy", None))
#if QT_CONFIG(tooltip)
        ...
        self.dateEdit_show_collected_by_day.setDisplayFormat(QCoreApplication.translate("MainWindow", u"d/MM/yyyy", None))
#if QT_CONFIG(tooltip)
